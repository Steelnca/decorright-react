    ...
    return (
        <div ref={rootRef} className="w-full h-full">
            ...
            <div className="flex max-lg:flex-col gap-4 mb-4 w-full">
                ...
                <div className="flex max-lg:flex-wrap items-center gap-2 md:gap-4">
                    ...
                    <div className="relative flex items-center max-xs:w-full h-fit rounded-full border border-muted/15 bg-surface">
                        ...
                        className="text-xs md:text-sm appearance-none min-w-fit p-2 pr-8 cursor-pointer focus:outline-none"
                        >
                    ...
                    <div className="relative flex items-center max-xs:w-full h-fit rounded-full border border-muted/15 bg-surface">
                        ...
                        className="flex appearance-none text-xs md:text-sm p-2 pr-8 min-w-fit cursor-pointer focus:outline-none"
                        >
                    ...
                    <div className="relative flex items-center max-xs:w-full h-fit rounded-full border border-muted/15 bg-surface">
                        ...
                        <div className="relative flex items-center w-full">
                            ...
                            className="appearance-none text-xs md:text-sm p-2 pr-8 min-w-fit cursor-pointer focus:outline-0">
