...
export function MenuCard({title, children, open, setOpen}: {title: string, children:any, open:boolean, setOpen:any}) {
    ...
    return (
        ...
        <>
                ...
                <div ref={wrapperRef} className="fixed flex justify-center top-16 md:top-18 right-0 w-full md:w-w-[22rem] lg:w-1/3 xl:w-1/4 h-[calc(100vh-4rem)] md:h-[calc(100vh-4.5rem)]">
