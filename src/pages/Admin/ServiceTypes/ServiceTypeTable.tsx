            ...
            <table className="w-full">
                <thead className="bg-surface/50 sticky top-0 z-10">
                    <tr className="border-b border-muted/15">
                        ...
                        <th className="px-4 py-3 text-left text-xs font-semibold text-muted uppercase tracking-wider">Sort Order</th>
                    ...
                    {serviceTypes.length === 0 ? (
                        ...
                        serviceTypes.map((serviceType) => (
                            <tr key={serviceType.id} className="hover:bg-surface/30 transition-colors">
                                ...
                                <td className="px-4 py-3 text-sm text-muted">{serviceType.sort_order}</td>
